 ...
 * 
 */
#ifndef __APP_ADAPTER_FLASH_H__
#define __APP_ADAPTER_FLASH_H__
...
/**< 适配运行状态 */
typedef enum {
    FLASH_ADAPTER_OK = 0,        /**< 运行成功 */
    FLASH_ADAPTER_ERROR,         /**< 运行错误 */
}app_adapter_flash_status_e;

/**
 * @brief 注册flash设备到驱动层
 * 
 * @return app_adapter_flash_status_e 运行状态
 */
